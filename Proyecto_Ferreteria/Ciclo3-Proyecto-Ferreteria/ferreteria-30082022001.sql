...
INSERT INTO `productos` (`id`, `nombre`, `cantidad`, `descripcion`, `precio_unidad`) VALUES
	(1, 'Cizalla corta', 10, NULL, 133900),
	(2, 'Cortador de tubos', 15, NULL, 50900),
	(3, 'Juego de copas', 10, '1/4 y 3/8, 39 Piezas', 50900),
	(4, 'Pistola Calafateadora', 15, NULL, 44500),
	(5, 'Pinza de presion', 15, NULL, 43900),
	(6, 'Llave para plomero', 5, NULL, 42900),
	(7, 'Llave copa multiusos', 10, '', 41300),
	(8, 'Broca para hierro', 30, NULL, 39913),
	(9, 'Alicate', 10, NULL, 38500),
	(10, 'Hombresolo', 10, 'Punta larga', 33900);
